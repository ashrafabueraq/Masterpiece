...
<div class="container" style="margin-top:200px; margin-bottom:75px;">
    ...
    <div class="main-body">
        <div class="row">
                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-secondary mb-1">{{Auth::user()->email}}</p>
                                 <p class="text-muted font-size-sm">{{Auth::user()->address}}, {{Auth::user()->phone}}</p> 
            ...
            <div class="col-lg-8">
                ...
                <form  method="POST" action="{{route('prof.update',Auth::user()->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0"><label class="labelname" for="username">UserName</label></h6> 
                            </div>
                            <div class="col-sm-9 text-secondary">
                                <input id="username" type="text" class="form-control" value={{Auth::user()->name}} name='name'>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0"><label  class="labelname" for="email">Email</label></h6> 
                            </div>
                            <div class="col-sm-9 text-secondary">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0"><label  class="labelname" for="password">PassWord</label></h6> 
                            </div>
                            <div class="col-sm-9 text-secondary">
              ...
              <div class="card mb-3">
                ...
                <form action="" method="POST">
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input id="username" type="text" class="form-control" value="john@example.com">
                    </div>
                 </div>
